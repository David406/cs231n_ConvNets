...
class TwoLayerNet(object):
    ...
    def __init__(self, input_dim=3*32*32, hidden_dim=100, num_classes=10,
        ...
        ############################################################################
        self.params['W1'] = np.random.normal(0, weight_scale, hidden_dim*input_dim).reshape(input_dim, hidden_dim)
    ...
    def loss(self, X, y=None):
        ...
        scores, cache_3 = affine_forward(out_2, self.params['W2'], self.params['b2'])
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dout, grads['W2'], grads['b2'] = affine_backward(dout, cache_3)
        dout = relu_backward(dout, cache_2)
        dout, grads['W1'], grads['b1'] = affine_backward(dout, cache_1)
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dout, grads['W'+str(self.num_layers)], grads['b'+str(self.num_layers)] = affine_backward(dout, caches[self.num_layers-1][0])
