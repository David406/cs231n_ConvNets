...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        h = H//2; w = W//2
        self.params['W2'] = np.random.normal(0, weight_scale, h*w*num_filters*hidden_dim).reshape(h*w*num_filters, hidden_dim)
    ...
    def loss(self, X, y=None):
        ...
        scores, scores_affine_cache = affine_forward(affine_relu_out, W3, b3)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dout, grads['W3'], grads['b3'] = affine_backward(dout, scores_affine_cache)
